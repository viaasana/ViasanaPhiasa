...
const MyHeader = () => {
    const TEXT = {
        Vietnamese: {
            ...
            a2: " Hỗ Trợ",
            search: "Tìm kiếm",
            assignment: "Bài Tập" // New text for the assignment button
        },
        Khmer: {
            a1: " សេចក្តីជូនដំណឹង",
            a2: " គាំទ្រ",
            search: "ស្វែងរក",
            assignment: "កិច្ចការ" // New text for the assignment button
        },
        English: {
            a1: " Notification",
            a2: " Help",
            search: "Search",
            assignment: "Assignment" // New text for the assignment button
        }
    }
    ...
    const goToAssignment = () => {
        navigate("/assignment") // Navigate to the assignment page
    }
            ...
            <div className="navbar">
                <a href="/assignments">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="white">
                        <path d="M14.707 9.707l-1.414 1.414L15.586 13l1.414-1.414-2.293-2.293zm-5.414 0L7.879 11l2.293 2.293 1.414-1.414L9.707 9.707zm8.207-6.707H6.000c-1.104 0-2 .896-2 2v16c0 1.104.896 2 2 2h12c1.104 0 2-.896 2-2V5.000c0-1.104-.896-2-2-2zm0 18H6.000V5.000h12v16z" />
                    </svg>
